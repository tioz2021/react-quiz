...
import classes from '../QuizCreator/QuizCreator.module.scss'
...
class QuizCreator extends Component {
  ...
  addQuestionHandler = event => {
    ...
    const questionItem = {
      ...
      rightAnwerId: this.state.rightAnwerId,
      answers: [
  ...
  selectChangeHandler = (event) => {
    this.setState({
      rightAnwerId: +event.target.value
    })
  }
